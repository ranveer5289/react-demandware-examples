...
var PromiseMap = function () {
  ...
  PromiseMap.prototype.resolveKey = function resolveKey(key, value) {
    ...
    !!entry.isSettled() ? dw.system.System.getInstanceType() !== dw.system.System.PRODUCTION_SYSTEM ? invariant(false, 'PromiseMap: Already settled `%s`.', key) : invariant(false) : void 0;
    entry.resolve(value);
  };
