    ...
    function sendTimedRequest() {
      ...
      var requestTimeout = setTimeout(function () {
        ...
        if (shouldRetry(requestsAttempted)) {
          dw.system.System.getInstanceType() !== dw.system.System.PRODUCTION_SYSTEM ? warning(false, 'fetchWithRetries: HTTP timeout, retrying.') : void 0;
          retryRequest();
        } else {
      ...
      request.then(function (response) {
        ...
        if (isRequestAlive) {
          ...
          if (response.status >= 200 && response.status < 300) {
            ...
            dw.system.System.getInstanceType() !== dw.system.System.PRODUCTION_SYSTEM ? warning(false, 'fetchWithRetries: HTTP error, retrying.') : void 0, retryRequest();
          } else {
