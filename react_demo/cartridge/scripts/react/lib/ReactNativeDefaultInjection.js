...
function inject() {
  ...
  ReactHostComponent.injection.injectGenericComponentClass(function (tag) {
    ...
    !false ? dw.system.System.getInstanceType() !== dw.system.System.PRODUCTION_SYSTEM ? invariant(false, 'Expected a component class, got %s.%s', tag, info) : _prodInvariant('18', tag, info) : void 0;
  });
}
