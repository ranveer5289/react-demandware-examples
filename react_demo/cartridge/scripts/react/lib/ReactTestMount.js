...
ReactTestInstance.prototype.update = function (nextElement) {
  !this._component ? dw.system.System.getInstanceType() !== dw.system.System.PRODUCTION_SYSTEM ? invariant(false, 'ReactTestRenderer: .update() can\'t be called after unmount.') : _prodInvariant('139') : void 0;
