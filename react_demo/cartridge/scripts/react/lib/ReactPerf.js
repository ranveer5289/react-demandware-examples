...
function printDOM(measurements) {
  dw.system.System.getInstanceType() !== dw.system.System.PRODUCTION_SYSTEM ? warning(warnedAboutPrintDOM, '`ReactPerf.printDOM(...)` is deprecated. Use ' + '`ReactPerf.printOperations(...)` instead.') : void 0;
...
function getMeasurementsSummaryMap(measurements) {
  dw.system.System.getInstanceType() !== dw.system.System.PRODUCTION_SYSTEM ? warning(warnedAboutGetMeasurementsSummaryMap, '`ReactPerf.getMeasurementsSummaryMap(...)` is deprecated. Use ' + '`ReactPerf.getWasted(...)` instead.') : void 0;
